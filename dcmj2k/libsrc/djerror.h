...
#include "dcmtk/dcmj2k/dj2kutil.h" /* For the OFCondition codes */
#include "openjpeg.h" /* OpenJPEG include */

/** Helper class for converting between dcmj2k and OpenJPEG error codes
 */
class DJ2KError
{
private:
...
public:
  ...
  /** This method converts a OpenJPEG error code into a dcmj2k OFCondition
