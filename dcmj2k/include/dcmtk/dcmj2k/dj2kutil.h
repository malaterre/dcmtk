...
#include "dcmtk/dcmj2k/dldefine.h"
...
extern DCMTK_DCMJ2K_EXPORT OFLogger DCM_dcmj2kLogger;

#define DCMJ2K_TRACE(msg) OFLOG_TRACE(DCM_dcmj2kLogger, msg)
#define DCMJ2K_DEBUG(msg) OFLOG_DEBUG(DCM_dcmj2kLogger, msg)
#define DCMJ2K_INFO(msg)  OFLOG_INFO(DCM_dcmj2kLogger, msg)
#define DCMJ2K_WARN(msg)  OFLOG_WARN(DCM_dcmj2kLogger, msg)
#define DCMJ2K_ERROR(msg) OFLOG_ERROR(DCM_dcmj2kLogger, msg)
#define DCMJ2K_FATAL(msg) OFLOG_FATAL(DCM_dcmj2kLogger, msg)


// include this file in doxygen documentation

/** @file djlsutil.h
 *  @brief type definitions and constants for the dcmj2k module
 */
