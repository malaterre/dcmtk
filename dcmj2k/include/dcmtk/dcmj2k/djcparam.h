...
#ifndef DCMJ2K_DJCPARAM_H
#define DCMJ2K_DJCPARAM_H

#include "dcmtk/config/osconfig.h"
#include "dcmtk/dcmdata/dccodec.h" /* for DcmCodecParameter */
#include "dcmtk/dcmj2k/dj2kutil.h" /* for enums */

/** codec parameter for JPEG-LS codecs
 */
class DCMTK_DCMJ2K_EXPORT DJ2KCodecParameter: public DcmCodecParameter
{
public:
