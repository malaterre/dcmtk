...
#ifndef DCMJ2K_DJCODECD_H
#define DCMJ2K_DJCODECD_H
 ...
 */
class DCMTK_DCMJ2K_EXPORT DJ2KDecoderBase: public DcmCodec
{
public:
 ...
 */
class DCMTK_DCMJ2K_EXPORT DJ2KLosslessDecoder : public DJ2KDecoderBase
{
  /** returns the transfer syntax that this particular codec
   *  is able to Decode
   *  @return supported transfer syntax
 ...
 */
class DCMTK_DCMJ2K_EXPORT DJ2KNearLosslessDecoder : public DJ2KDecoderBase
{
  /** returns the transfer syntax that this particular codec
   *  is able to encode
   *  @return supported transfer syntax
