...
#ifndef DCMJ2K_DJCODEC_H
#define DCMJ2K_DJCODEC_H
 ...
 */
class DCMTK_DCMJ2K_EXPORT DJ2KEncoderBase : public DcmCodec
{
public:
 ...
 */
class DCMTK_DCMJ2K_EXPORT DJ2KLosslessEncoder : public DJ2KEncoderBase
{
  /** returns the transfer syntax that this particular codec
   *  is able to encode
   *  @return supported transfer syntax
 ...
 */
class DCMTK_DCMJ2K_EXPORT DJ2KNearLosslessEncoder : public DJ2KEncoderBase
{
  /** returns the transfer syntax that this particular codec
   *  is able to encode
   *  @return supported transfer syntax
