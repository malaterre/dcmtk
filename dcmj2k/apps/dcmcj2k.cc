...
#include "dcmtk/dcmj2k/dj2kutil.h"   /* for dcmj2k typedefs */
#include "dcmtk/dcmj2k/djencode.h"   /* for class DJ2KEncoderRegistration */
#include "dcmtk/dcmj2k/djrparam.h"   /* for class DJ2KRepresentationParameter */
