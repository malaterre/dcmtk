...
#include "dcmtk/dcmjp2k/dj2kutil.h"   /* for dcmjpgls typedefs */
#include "dcmtk/dcmjp2k/djdecode.h"   /* for JPEG-LS decoder */
...
#endif
          COUT << "- " << DJ2KDecoderRegistration::getLibraryVersionString() << OFendl;
          return 0;
        }
      }
...
LICENSE_FILE_EVALUATE_COMMAND_LINE_OPTIONS
      ...
      if (cmd.findOption("--read-dataset"))
      {
        ...
        opt_ixfer = EXS_JPEG2000LosslessOnly;
      }
      cmd.endOptionBlock();
